...
public enum TowerType {
	...
	TowerIce(new Texture[]{QuickLoad("TBaseFrostTower64"), QuickLoad("FrostTurret64")}, ProjectileType.SnowBall, 30, 650, 1.8f, 1000f, 55),
	TowerPoison(new Texture[]{QuickLoad("TBasePoisonTower64"), QuickLoad("PoisonTurret64")}, ProjectileType.PoisonBall, 1, 450, 1.8f, 650f, 45),
